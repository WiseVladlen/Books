...
ImageLinksDTO _$ImageLinksDTOFromJson(Map<String, dynamic> json) => ImageLinksDTO(
      thumbnail: json['thumbnail'] as String,
    );

VolumeInfoDTO _$VolumeInfoDTOFromJson(Map<String, dynamic> json) => VolumeInfoDTO(
...
BookDTO _$BookDTOFromJson(Map<String, dynamic> json) => BookDTO(
      ...
      volumeInfo: VolumeInfoDTO.fromJson(json['volumeInfo'] as Map<String, dynamic>),
    );

BookResponseDTO _$BookResponseDTOFromJson(Map<String, dynamic> json) => BookResponseDTO(
